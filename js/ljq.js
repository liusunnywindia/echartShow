...
var resizeWorldMapContainer = function () {
    ...
    worldMapContainer1.style.height = ((window.innerHeight-66)/3)+'px';
      worldMapContainer2.style.height = ((window.innerHeight-40)/2-110)+'px';
       // worldMapContainer3.style.height = (window.innerHeight/3-30)+'px';
          worldMapContainer4.style.height = ((window.innerHeight-66)*2/3-10)+'px';
        ...
        $.ajax({
            ...
            success: function(datazj) {
          	if(datazj){
          	   ...
          	   option7.series['2'].data=convertData(obj2);console.log(obj2);
